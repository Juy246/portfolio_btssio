    ...
    public function load(ObjectManager $manager): void
    {
        $certifications = [
            [
                ...
                'image_file' => 'certification_pix.png',
            ...
            [
                ...
                'image_file' => 'Cyber_Threat_Management_certificate.png',
            ...
            [
                ...
                'image_file' => 'Introduction_to_Cybersecurity_certificate.png',
        ...
        foreach ($certifications as $data) {
            ...
            if ($existing) {
                ...
                $existing->setImageFile($data['image_file'] ?? null);
                ...
                $certification->setImageFile($data['image_file'] ?? null);
